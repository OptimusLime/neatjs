...
//                    self.population.push(copy);
    ...
    multiobjective.MultiobjectiveSearch = function(seedGenomes, genomeEvaluationFunctions, neatParameters, searchParameters)
    {
        ...
        multiobjective.MultiobjectiveSearch.prototype.initializePopulation = function()
        {
        ...
        multiobjective.MultiobjectiveSearch.prototype.matchConnectionIDs = function()
        {
        ...
        multiobjective.MultiobjectiveSearch.prototype.incrementAges = function()
        {
        ...
        multiobjective.MultiobjectiveSearch.prototype.updateFitnessStats = function()
        {
        ...
        multiobjective.MultiobjectiveSearch.prototype.tournamentSelect = function(genomes)
        {
            var bestFound= 0.0;
            var bestGenome=null;
        ...
        multiobjective.MultiobjectiveSearch.prototype.evaluatePopulation= function()
        {
        ...
        multiobjective.MultiobjectiveSearch.prototype.performOneGeneration = function()
        {
        ...
        multiobjective.MultiobjectiveSearch.prototype.createOffSpring = function()
        {
            self.offspringList = [];
        ...
        multiobjective.MultiobjectiveSearch.prototype.createMultipleOffSpring_Asexual = function()
        {
        ...
        multiobjective.MultiobjectiveSearch.prototype.createMultipleOffSpring_Sexual = function()
        {
            //function for testing if offspring is valid
            var validOffspring = self.genomeEvaluationFunctions.isValidOffspring || function() {return true;};
            var attemptValid = self.genomeEvaluationFunctions.validOffspringAttempts || 5;
